        ...
        <header className={moduleClasses["header"]}>
            ...
            <div className={moduleClasses["header__wrapper"]}>
                <div>
                    ...
                    <a className={moduleClasses["header__email"]} href={'info@diagnistics.by'}>info@diagnistics.by</a>
                </div>
                <div className={moduleClasses["header__tel"]}>
                    <p className={moduleClasses["header__text"]}>Есть вопросы? Звоните!</p>
                    <a  className={moduleClasses["header__tel-link"]} href={'+375 (29) 456-45-45'}>+375 (29) 456-45-45</a>
                </div>
            </div>
        </header>
    )
